...
export const BUILDINGS = ['hq', 'camp', 'academy', 'academy_t2', 'lumber', 'lumber_t2', 'lumber_t3', 'mine', 'mine_t2', 'mine_t3', 'papermill', 'farm', 'house', 'fortress', 'fortress_t2', 'fortress_t3', 'forge', 'furnace'];
export const T2_BUILDINGS = ['academy', 'lumber_t2', 'mine_t2', 'fortress_t2', 'furnace'];
...
export const BUILDING_LIMITS = { hq: 1, camp: 1, academy: 1, academy_t2: 1, papermill: 1, lumber: 2, mine: 2, farm: 2, fortress: 4, forge: 1, furnace: 2 };
export const FORTRESS_HP = { fortress: 2, fortress_t2: 4, fortress_t3: 8 };